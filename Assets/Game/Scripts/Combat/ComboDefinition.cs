...
namespace ClockWork.Game
{
    ...
    public class ComboDefinition : ScriptableObject
    {
        ...
        {
            new() { hitboxOffset = new Vector2(0.55f, 0.05f), hitboxSize = new Vector2(0.72f, 0.58f), useRightHand = true, motionHold = 0.35f },
            new() { hitboxOffset = new Vector2(0.38f, 0.08f), hitboxSize = new Vector2(0.65f, 0.52f), useRightHand = false, motionHold = 0.6f },
            new() { hitboxOffset = new Vector2(0.62f, 0.06f), hitboxSize = new Vector2(0.85f, 0.65f), useRightHand = true, motionHold = 0.6f }
        };
