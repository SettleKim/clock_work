...
- 상세: [Movement.md — 갈고리](Docs/Movement.md#갈고리)
- **Momentum 비행 거리:** 포인트 `LaunchSpeed`만으로 발사 (플레이어 속도 미반영). 속도 반영 아이디어는 [Movement.md](Docs/Movement.md) 보류 기록.
