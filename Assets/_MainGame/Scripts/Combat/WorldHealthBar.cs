...
namespace ClockWork.Game
{
    ...
    public class WorldHealthBar : MonoBehaviour
    {
        ...
        public void Configure(BarStyle barStyle, bool showCumulativeDamage)
        {
            style = barStyle;
            showTotalDamage = showCumulativeDamage;
            ApplyStyleColors();
        }
        ...
        void ApplyStyleColors()
        {
            ...
            fillRenderer.color = style == BarStyle.Player
                ? new Color(0.35f, 0.72f, 0.95f, 0.95f)
                : new Color(0.35f, 0.9f, 0.45f, 0.95f);

            if (totalDamageText != null)
                totalDamageText.gameObject.SetActive(showTotalDamage);
        }
        ...
        void OnHealthChanged(float current, float max)
        {
            ...
            if (fillRenderer != null)
            {
                ...
                Color healthy = style == BarStyle.Player
                    ? new Color(0.35f, 0.72f, 0.95f, 0.95f)
                    : new Color(0.35f, 0.9f, 0.45f, 0.95f);
        ...
        {
            if (totalDamageText == null || !showTotalDamage)
                return;
